    ...
    <section className='bg-primary py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8'>
      <div className='max-w-7xl mx-auto'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8'>
          <article className='relative rounded-lg overflow-hidden shadow-md hover-lift cursor-pointer'>
          ...
          <article className='relative rounded-lg overflow-hidden shadow-md hover-lift cursor-pointer md:col-span-2 lg:col-span-1'>
